...
public class MouseOrbit : MonoBehaviour
{
    ...
    //Clamp Value
    [Range(-90, -10)]
    public float minXRotAngle = -70; //min angle around x axis
    [Range(10, 90)]
    public float maxXRotAngle = 70; // max angle around x axis
    [Range(0, 100)]
    public float minCameraFieldOfView = 30;
    [Range(0, 100)]
    public float maxCameraFieldOfView = 95;
    Vector3 dir;
